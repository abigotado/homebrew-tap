class RedmineAgentCli < Formula
  ...
  def install
    ...
    resource("github.com/creack/pty").stage do
      (buildpath/"vendor/github.com/creack/pty").install Pathname("github.com/creack/pty@v1.1.24").children
    end
    resource("github.com/inconshreveable/mousetrap").stage do
      module_root = Pathname("github.com/inconshreveable/mousetrap@v1.1.0")
    ...
    resource("github.com/spf13/cobra").stage do
      (buildpath/"vendor/github.com/spf13/cobra").install Pathname("github.com/spf13/cobra@v1.10.2").children
    end
    resource("github.com/spf13/pflag").stage do
      (buildpath/"vendor/github.com/spf13/pflag").install Pathname("github.com/spf13/pflag@v1.0.9").children
    end
    resource("golang.org/x/sys").stage do
      (buildpath/"vendor/golang.org/x/sys").install Pathname("golang.org/x/sys@v0.44.0").children
    end
    resource("golang.org/x/term").stage do
      (buildpath/"vendor/golang.org/x/term").install Pathname("golang.org/x/term@v0.32.0").children
    end
