class RedmineAgentCli < Formula
  ...
  def install
    ...
    resource("github.com/creack/pty").stage buildpath/"vendor/github.com/creack/pty"
    resource("github.com/inconshreveable/mousetrap").stage buildpath/"vendor/github.com/inconshreveable/mousetrap"
    resource("github.com/spf13/cobra").stage buildpath/"vendor/github.com/spf13/cobra"
    resource("github.com/spf13/pflag").stage buildpath/"vendor/github.com/spf13/pflag"
    resource("golang.org/x/sys").stage buildpath/"vendor/golang.org/x/sys"
    resource("golang.org/x/term").stage buildpath/"vendor/golang.org/x/term"
